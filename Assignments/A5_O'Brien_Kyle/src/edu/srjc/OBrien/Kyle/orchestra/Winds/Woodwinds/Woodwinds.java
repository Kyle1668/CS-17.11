...
public abstract class Woodwinds extends Winds
{
    private boolean hasReed = false;
    private boolean hasDoubleReed = false;
    ...
    public boolean hasDoubleReed()
    {
        return hasDoubleReed;
    }

    public void setHasDoubleReed(boolean hasDoubleReed)
    {
        this.hasDoubleReed = hasDoubleReed;
    }
}
