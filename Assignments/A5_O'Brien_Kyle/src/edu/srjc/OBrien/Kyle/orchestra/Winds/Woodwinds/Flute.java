...
public class Flute extends Woodwinds
{
    public Flute()
    {
        ...
        String description = "The flute is a family of musical instruments in the woodwind group. \n" +
                "Unlike woodwind instruments with reeds, a flute is an aerophone or reedless \n" +
                "wind instrument that produces its sound from the flow of\n" +
