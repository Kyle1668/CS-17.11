...
public class Horn extends Brasswind
{
    ...
    public Horn()
    {
        ...
        String hornDesc = "A horn is any of a family of musical instruments made of a tube, \n" +
                "usually made of metal and often curved in various ways, with one narrow end into which \n" +
                "the musician blows, and a wide end from which sound emerges.\n" +
                "\nIt has " + getValveCount() + " valves." + transposingDesc + "\n";

        this.setDescription(hornDesc);
    }
