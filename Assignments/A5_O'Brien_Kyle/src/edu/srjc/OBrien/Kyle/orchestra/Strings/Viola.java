...
public class Viola extends Strings
{
    ...
    public Viola()
    {
        ...
        this.keys().add(Key.C);
        this.clefs().add(Clef.Alto);
        this.clefs().add(Clef.Treble);

        String violaDesc = "The viola is a string instrument that is bowed or played with varying \n" +
                "techniques. It is slightly larger than a violin and has a lower and deeper sound. " +
