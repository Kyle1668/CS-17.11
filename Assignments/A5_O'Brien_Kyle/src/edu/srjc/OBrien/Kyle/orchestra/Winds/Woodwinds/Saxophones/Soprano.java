...
public class Soprano extends Saxophones
{
    public Soprano()
    {
        ...
        String description = "The soprano saxophone is a higher-register variety of the saxophone, \n" +
                "a woodwind instrument, invented in the 1840s. The soprano is the third smallest \n" +
                "member of the saxophone family, which consists (from smallest to largest) of \n" +
                "the soprillo, sopranino, soprano, alto, tenor, baritone, bass, contrabass \n" +
                "saxophone and tubax.\n" +
