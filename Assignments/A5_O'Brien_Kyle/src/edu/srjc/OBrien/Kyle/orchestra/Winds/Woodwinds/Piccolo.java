...
public class Piccolo extends Woodwinds
{
    public Piccolo()
    {
        ...
        String description = "The piccolo /ˈpɪkəloʊ/ (Italian pronunciation: [ˈpikkolo]; Italian for\n" +
                " \"small\", but named ottavino in Italy)[2] is a half-size flute, and a \n" +
                "member of the woodwind family of musical instruments.\n" +
